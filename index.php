...
$targets = array("login","registration","register","dashboard","contact","logout","about","addUser","favourite","message","first_connection","next_step","changePassword","newpassword","new_home","delete","testing");
