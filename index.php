...
$targets = array(0=>"login",1=>"registration",2=>"register",3=>"dashboard",4=>"contact");
$paths = array("/Controllers/c_login.php","/Controllers/c_registration.php","/Views/register.php","/Views/dashboard.php","/Views/contact.php");
